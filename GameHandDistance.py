...
while True:
    ...
    if time.time()-timeStart < totalTime:
        ...
        cv2.circle(img, (cx, cy), 30, (0, 50, 0), 2)
        ...
        cvzone.putTextRect(img, 'End Game', (400, 400), scale=5, offset=30, thickness=7)
        cvzone.putTextRect(img, f' Score : {score}', (450, 500), scale=3, offset=20)
        cvzone.putTextRect(img, 'Press R to restart game', (460, 575), scale=2, offset=10)
